...
查看最新学位论文格式可以进入[天津大学研究生学位管理系统](http://121.193.130.234:7001/Degree/)，查看“学位论文格式规定”条目下的最新官方文件。
...
+ 2016.11.11：从[天津大学学位管理系统](http://121.193.130.234:7001/Degree/)下载了官方的格式规定文档（参考文献格式规定的起止页码间的符号为“-”，而信息学院转发的文档中的符号为“~”）。
 
+ 2016.11.12：格式规定文档更新了，学院和研究生院的也统一了。区别：“中文摘要”改回“摘要”二字；目录深度修改，改回到包括章标题在内的三级标题；参考文献格式规定的起止页码间的符号为“~”；第几章使用阿拉伯数字，比如“第一章”改为“第1章”。

+ 2016.11.29：独创性声明页的“天津大学”四字的字号修改为四号。
